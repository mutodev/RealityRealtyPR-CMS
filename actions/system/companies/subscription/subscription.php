...
if ($Form->isValid()){
    ...
    //Update Customer
    $Company      = Doctrine::getTable('Company')->findOneById($id);
    $CompanyAdmin = $Company->getAdmin();
    ...
    $customer = array(
        ...
        "email" => $values['invoice_recipient'] ? "alberto+{$id}@rpm.realityrealtypr.com" : $CompanyAdmin->email,
