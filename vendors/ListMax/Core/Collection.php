<?php
    ...
    class ListMax_Core_Collection implements Countable, Iterator, ArrayAccess {
		...
		public function __construct( ){		
            ...
            //Get the item class
            $this->itemClass = preg_replace("/_Collection$/", "_Item" , get_class( $this ) );
        ...
        /* ------------------------------------------------ */
		public function isValidOrderBy( $key ){
			
			$function = "order_".strtolower( $key );
        ...
        protected function order( &$select ){
            ...
            for( $i = 0 ; $i < count( $this->orderedBy ) ; $i++ ){
                ...
                if( $orderBy == "rand" ){
					...
					$function = "order_".strtolower( $orderBy );		
					if( method_exists( $this , $function ) )
