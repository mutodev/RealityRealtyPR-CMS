...
if (function_exists('childtheme_override_page_title'))  {
	...
	function thematic_page_title() {
		...
		$content = '';
		if (is_attachment()) {
				$content .= '<h2 class="page-title-2"><a href="';
				...
				$content .= '<h1 class="page-title-2 author">';
...
if (function_exists('childtheme_override_postmeta_authorlink'))  {
	...
	function thematic_postmeta_authorlink() {
	    ...
	    $authorlink = '<span class="meta-prep meta-prep-author">' . __('Publicado por ', 'thematic') . '</span>';
...
if (function_exists('childtheme_override_postmeta_entrydate'))  {
	...
	function thematic_postmeta_entrydate() {
	    ...
	    $entrydate = '<span class="meta-prep meta-prep-entry-date">' . __('Fecha: ', 'thematic') . '</span>';
		...
		foreach($spanish_months as $k => $m){
			$entrydate = str_replace($k, $m, $entrydate);
		}
	    $entrydate .= '</abbr></span>';
...
if (function_exists('childtheme_override_postfooter_postcategory'))  {
	...
	function thematic_postfooter_postcategory() {
	    ...
	    if (is_single()) {
	        $postcategory .= __('Publicado en ', 'thematic') . get_the_category_list(', ');
	        $postcategory .= '</span>';
	    } elseif ( is_category() && $cats_meow = thematic_cats_meow(', ') ) { /* Returns categories other than the one queried */
	        $postcategory .= __('También publicado en ', 'thematic') . $cats_meow;
