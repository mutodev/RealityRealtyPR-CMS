<?php
    ...
    class Helper_Form_Renderer_Layout_Grid extends Helper_Form_Renderer_Layout{
        ...
        public function render( $element , $options ){
            ...
            $output[] = "\t<table class='$classes' style='$style'>";
                foreach( $elements as $element ){

                    if( $i == 0 )  {      
                       $rowodd        = !$rowodd;
                       $row_classes   = array();
                       $row_classes[] = "ym-form-layout-grid-row";
                       $row_classes[] = $rowodd ? "ym-form-layout-grid-row-odd" : "ym-form-layout-grid-row-even";
                       $row_classes   = implode( " " , $row_classes );
                       $output[] = "\t\t<tr class='$row_classes'>";
                    }
