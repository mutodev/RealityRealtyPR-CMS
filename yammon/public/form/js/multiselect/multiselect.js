...
var MultiSelect = new Class({
		...
		boxes.each(function(box, i) {
			box.addEvents({
				...
				'keydown': function(e) {
					if (e.key == 'space') {
						self.active = true;
						self.changeItemState(this.getParent(), this, monitor, 'space');
					}
	...
	changeItemState: function(item, checkbox, monitor, method) {
...
window.addEvent( 'domready' , function(){
    new MultiSelect( '.yammon-form-checkboxes-select' );
});
*/