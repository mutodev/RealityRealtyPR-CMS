...
$error_flash_template    = t("Couldn't find the slideshow image for editing" );
$update_flash_template   = t("Successfully updated Slideshow Image: <a href='/admin/slideshow/edit/?id=%0'> %1 </a>" , "%{id}" , "%{title}" );
