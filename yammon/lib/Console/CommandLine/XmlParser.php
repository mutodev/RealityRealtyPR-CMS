...
class Console_CommandLine_XmlParser
{
    ...
    /*
        if (is_dir('/Applications/MAMP/bin/php5/lib/php/data' . DIRECTORY_SEPARATOR . 'Console_CommandLine')) {
            $rngfile = '/Applications/MAMP/bin/php5/lib/php/data' . DIRECTORY_SEPARATOR
